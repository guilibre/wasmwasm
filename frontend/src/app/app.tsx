    ...
    return (
        <div className="app">
            ...
            <div className="app__examples">
                <button onClick={() => loadExample(chuas_circuit)}>Chua's Circuit</button>
                <button onClick={() => loadExample(double_pendulum)}>Double Pedulum</button>
                <button onClick={() => loadExample(harmonic_oscillator)}>
                    Harmonic Oscillator
                </button>
                <button onClick={() => loadExample(karplus_strong)}>Karplus-Strong</button>
            </div>
